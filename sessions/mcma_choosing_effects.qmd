...
#### What estimand do we want? {.unnumbered}
...
#### What if positivity assumption $\P(A=a\mid W)>0$ is violated? {.unnumbered}
...
#### What if the exposure variable is continuous? {.unnumbered}
...
#### What if the exposure is actually time-varying? What if the mediators and/or intermediate confounders are time-varying? {.unnumbered}
