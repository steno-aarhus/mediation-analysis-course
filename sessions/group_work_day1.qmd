...
dataset. - Conduct mediation analysis using the traditional approaches

-   Conduct mediation analysis using the 'mediaiton' R package
...
Note: in this example, the outcome of interest is the prescence of CVD,
