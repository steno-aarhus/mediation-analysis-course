...
##AGReMA checklist
Recent reviews on mediation analyses have suggested that the reporting og documentation from these studies were insuffucient interpretation of the results and application for meta-analysis.

Based on this, a group of researchers have using a comprehensive consensus method developed a reporting checklist.
...
The list contains 25 items and in many ways resemble other reporting checklists.

```{r, echo = FALSE, fig.cap="Fig. 1. AGReMA checklist from Lee et al.", out.width = '100%'}
knitr::include_graphics(here::here("images", "agrema-checklist.PNG"))
```
...
The short list includes fewer items, but still emphasize key things to report. 

```{r, echo = FALSE, fig.cap="Fig. 1. AGReMA checklist from Lee et al.", out.width = '100%'}
knitr::include_graphics(here::here("images", "agrema-checklist-sf.PNG"))
```
