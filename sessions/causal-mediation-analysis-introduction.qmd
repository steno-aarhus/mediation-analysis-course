...
1.  First discuss the study you were assigned to in the previous
    session: (10 min)

-   How does the study separate the timing between the exposure,
    mediator and outcome?
-   Did the study account for all the confounding assumptions? If not,
