...
> TE =  $Y^{a=1}$ - $Y^{a=0}$ = $Y^{a=1,M_a=1}$ - $Y^{a=0,M_a=0}$ = ($Y^{a=1,M_a=1}$ - $Y^{a=1,M_a=0}$) + ($Y^{a=1,M_a=0}$ - $Y^{a=0,M_a=0}$) = NIE + NDE
...
- How does your study separate the timing between the exposure, mediator and outcome?
- Did your study account for all the confunding assumptions? If not, why not? What could they have done?
