...
This mean that a regression-based approach can in some situations also be used. However, for more complicated situations, the regression-based approach fail. The causal intuition in the regression-based approach is also less clear.
...
Now consider if we, in the same trial, could intervene on both because we are interested in whether treatment _causes_ the outcome because it _causes_ the mediator.
...
Discuss the different study designs used. How would you rank them? And what would be the ideal study design?
:::
...
- discussion about limitations - could use the studies we have in the exercise
- discuss when we can use traditional methods and when we cannot
