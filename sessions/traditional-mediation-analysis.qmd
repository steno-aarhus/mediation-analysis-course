...
blood glucose levels. Therefore, our research question aims to identify
and quantify the mediation effect mediated by this hypothetical
biomarker.
...
blood glucose, as depicted in the figure below. The purpose of mediation
analysis is to evaluate the effect of red meat intake on blood gluccose
change through its effect on this magic inflammatory biomarker.
...
Four demographic variables will be included in the analysis: age,
...
this new inflmmatory biomarker.
...
associated with higher blood glucose.
...
Red meat intake is strongly associated with higher glucose levels.
...
-   the *indirect effect* can be assessed by calculating the product of
    ...
    between red meat and glucose levels through inflammatory biomarker
    is 17.8.
...
-   the *total effect* ($\theta_1'$) of red meat on glucose levels can
    ...
    70.5. You might have noticed the total effect also equals the sum of
