...
The variables used in the dataset: -exposure of interest (x): red meat
intake: (continuous variable, grams per day) -outcome (y): plasma
fasting glucose (continuous variable, ) -mediator (m): a new
inflammatory biomarker (continuous variable)
