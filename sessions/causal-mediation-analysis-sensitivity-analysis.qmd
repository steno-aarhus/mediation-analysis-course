...
## Sensitivity analysis for natural dircect and indirect effects

### Sensitivity analysis for natural dircect and indirect effects in the abscence of exposure-mediator interction

A simple setting in which we can employ sensitivity analysis for natural
direct (NDE) and indirect effects (NIE) is when NDE and CDE coincide.
...
present and our estimates of the NDE and NIE are biased, the NDE and NIE
themselves will still combine to the correct total effect.
...
formulas that we used for CDE (and NDE). Thus on the additive scale, for
a continuous outcome, our bias factor for the NDE would simply be:
