...
- We can to use mediation analysis to explore the mechanisms underlying these
  differences.

- Key questions:
  - Do differences in the effects of treatment (comparing two medications for
    opioid use disorder, naltrexone v. buprenorphine) on risk of relapse
    operate through mediators of adherence, opioid use, pain, and depressive
    symptoms? [@rudolph2020explaining]
...
- That is, causal effects give you information about what would have happened
  *in some hypothetical world* where the mediator and treatment mechanisms
  changed.
